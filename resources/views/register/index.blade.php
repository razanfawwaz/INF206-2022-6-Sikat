        ...
        <div class="bg-white px-10 py-12 rounded-lg drop-shadow">
            ...
            @csrf
                ...
                <div class="mb-4">
                    ...
                    <input class="drop-shadow appearance-none border rounded-md w-full mt-2 px-4 py-2 pl-2 pr-4 w-full text-gray-700 leading-tight focus:outline-offset-2 focus:outline-blue-500 focus:shadow-outline" placeholder="Nomor HP" type="text" name="noHp" id="noHp" required="">
                </div>
                <div class="mb-4">

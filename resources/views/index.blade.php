...
<body class="bg-slate-100"> 
  <div>
  <nav class="bg-slate-100 border-gray-200 px-2 sm:px-4 py-2.5">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Flowbite</a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="targetEl">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        ...
        <li>
          <a href="#" class="block bg-blue-500 px-8 py-2 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Pricing</a>
        </li>
      </ul>
    </div>
  </div>

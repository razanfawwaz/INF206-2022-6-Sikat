  ...
  <nav class="border border-b-2 border-slate-300/40">
    <div class="bg-slate-100 border-gray-200 px-2 sm:px-4 py-2.5">
      <div class="container flex flex-wrap justify-between items-center mx-auto"> 
        <img src="./img/logo.png" alt="SIKAT" width="80px"><a class="self-center text-lg md:text-md font-semibold whitespace-nowrap text-slate-500">Sistem Informasi Kecemasan Darurat</a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="targetEl">
          <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li> <a href="/overview" class="block py-4 mt-2 pr-4 pl-3 text-gray-700  hover:bg-gray-50 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Cara Kerja</a> </li>
            <li>
